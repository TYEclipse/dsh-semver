...
Agent 经常算错版本号问题——`1.0.0-beta.11` 和 `1.0.0-beta.2` 谁大？`1.2.4-beta.1` 是否满足 `^1.2.3`？本插件把这类问题变成确定性的工具调用。
...
三个工具全部**纯函数、离线**：无网络、无文件系统访问、无 shell、无动态求值。
...
pnpm test      # vitest，40+ 用例，全部取自 semver 规范 / npm 文档的已知锚点
